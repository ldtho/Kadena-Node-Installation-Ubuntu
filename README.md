...
rm chainweb-node
wget https://github.com/kadena-io/chainweb-node/releases/download/2.16/chainweb-2.16.ghc-8.10.7.ubuntu-20.04.b4e1147.tar.gz
tar -xvf chainweb-2.16.ghc-8.10.7.ubuntu-20.04.b4e1147.tar.gz
