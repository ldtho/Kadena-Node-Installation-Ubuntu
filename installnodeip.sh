...
NODE=https://github.com/kadena-io/chainweb-node/releases/download/2.14/chainweb-2.14.ghc-8.10.7.ubuntu-20.04.40d848f.tar.gz
...
tar -xvf chainweb-2.14.ghc-8.10.7.ubuntu-20.04.40d848f.tar.gz >> $LOG_FILE 2>&1
