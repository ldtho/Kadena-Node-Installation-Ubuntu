...
NODE=https://github.com/kadena-io/chainweb-node/releases/download/2.11.1/chainweb-2.11.1.ghc-8.10.7.ubuntu-20.04.a8ca246.tar.gz
...
tar -xvf chainweb-2.11.1.ghc-8.10.7.ubuntu-20.04.a8ca246.tar.gz >> $LOG_FILE 2>&1
